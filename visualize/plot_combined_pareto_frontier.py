...
csv_file = r"output\meta-llama_Llama-2-7b-hf_hellaswag_tp_powercap_summary_fixed_duration.csv"
csv_file = r"output\microsoft_Phi-3.5-MoE-instruct_hellaswag_tp_powercap_summary_fixed_duration.csv"
csv_file = r"output\Qwen_Qwen1.5-MoE-A2.7B_hellaswag_tp_powercap_summary_fixed_duration.csv"
csv_file = r"output\allenai_OLMoE-1B-7B-0924_hellaswag_tp_powercap_summary_fixed_duration.csv"
csv_file = r"output\deepseek-ai_deepseek-moe-16b-base_hellaswag_tp_powercap_summary_fixed_duration.csv"
csv_file = r"output\mistralai_Mixtral-8x7B-Instruct-v0.1_hellaswag_tp_powercap_summary_fixed_duration.csv"
csv_file = r"output\openai-community_gpt2_hellaswag_tp_powercap_summary_fixed_duration.csv"
